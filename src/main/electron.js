...
const UPDATE_DOWNLOAD_URL = 'https://github.com/Hong1495/Van/releases';
...
function notifyUpdateFailure(err, context)
{
	...
	try
	{
		dialog.showMessageBox(
		{
			type: 'error',
			title: 'Update Error',
			message: 'There was a problem updating Van.',
...
autoUpdater.on('update-available', safeUpdaterListener('update-available', (info) =>
{
	...
	dialog.showMessageBox(
	{
		...
		title: 'Confirm Van Update',
		message: `Van update available (${app.getVersion()} → ${info.version}).\n\nWould you like to download and install new version?`,
